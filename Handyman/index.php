...
.center {
  ...
  width: 50%;
	...
	<title>HANDYMAN AT DOORSTEP|| Home Page</title>
...
<body>
	...
	<div class="theme-wrap clearfix">
		...
		<div class="wsmenuexpandermain slideRight">
			...
			<img src="images/loo.png" width="120" alt="" />
		</div>
		...
		<section id="slider-revolution">
				...
				<div>
					<ul><!-- SLIDE  -->
						...
						<!-- MAIN IMAGE -->
							<img src="images/maini.jpg" alt="item slide" width="500" height="500" class="center">
						<!-- LAYERS -->	
